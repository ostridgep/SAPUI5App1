...
sap.ui.core.UIComponent.extend("sap.ui.demo.cart.Component", {
	...
	init : function () {
		...
		jQuery.sap.require("sap.ui.demo.cart.util.objectSearch");
		// 2. call overwritten init (calls createContent)
		sap.ui.core.UIComponent.prototype.init.apply(this, arguments);
		// 3a. monkey patch the router
		var oRouter = this.getRouter();
		oRouter.myNavBack = sap.ui.demo.cart.MyRouter.myNavBack;
		oRouter.myNavToWithoutHash = sap.ui.demo.cart.MyRouter.myNavToWithoutHash;
	...
	createContent : function () {
		...
		var oModel;
		if (!sap.ui.demo.cart.model.Config.isMock) {
