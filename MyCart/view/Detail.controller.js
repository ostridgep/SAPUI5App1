...
sap.ui.controller("sap.ui.demo.cart.view.Detail", {
	...
	_handleRouteMatched : function (evt) {
		...
		var sPath = sap.ui.demo.cart.util.objectSearch.getPath(oModel.getData(), "ID", this._detailId);
		if (!sPath) {
			this._oRouter.myNavToWithoutHash("sap.ui.demo.cart.view.NotFound", "XML", false, { path: this._detailId });
			return;
		}
	...
	handleTabSelect : function (evt) {
		...
		if (item.getContent().length === 0) {
			var view = new sap.ui.view({
				id : "tabView" + key,
				viewName : "sap.ui.demo.cart.view.Detail" + key,
				type : "XML"
			});
	...
	_createRecipientDialog : function (evt) {
		...
		this._recipientDialog = sap.ui.xmlfragment("sap.ui.demo.cart.view.RecipientHelpDialog", this);
